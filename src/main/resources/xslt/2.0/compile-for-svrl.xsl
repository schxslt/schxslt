<xsl:transform version="2.0"
  ...
  <!-- Output: an xslt file -->
  <!-- The output xslt file generates an svrl validation report equivalent to the report generated by oXygen or other validation environments -->
  <!-- The following import statements handle pre-processing of the input -->
  <xsl:import href="include.xsl"/>
  <xsl:import href="expand.xsl"/>
  
  <!-- For any input schematron file, first template encountered is within this import, for root element sch:schema -->
